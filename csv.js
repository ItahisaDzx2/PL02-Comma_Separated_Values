...
window.onload = function() {
	...
	if (window.localStorage && localStorage.original) {
		...
		document.getElementById("original").value = 'name, surname, "st address", city, country, "zip code"\nGeorge, Banks, "Number 17 Cherry Tree Lane", London, England, EC1A\nBruce, Wayne, "Stately Wayne Manor", "Gotham City", U.S.A., 10451\nMarty, McFly, "Lyon Estates", "Hill Valley, CA", U.S.A., 91185'
	}
};
